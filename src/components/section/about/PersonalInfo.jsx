  ...
  return (
    ...
    <div className='xl:flex mt-8 flex flex-col gap-8 xl:flex-row xl:gap-2'>
        ...
        <div className=' xl:w-[710px]'>
            <h1 className='px-5'>a 19-year-old residing in Novaliches, Quezon City. I can code using MERN (MongoDB, Express.js, React, Node.js) stack and I am actively seeking an internship opportunity to further enhance my skills.
            </h1>
